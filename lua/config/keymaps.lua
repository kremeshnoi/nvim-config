...
-- Tabs
keymap.set("n", "<M-h>", "<Cmd>BufferPrevious<CR>", { desc = "Previous buffer" })
keymap.set("n", "<M-l>", "<Cmd>BufferNext<CR>", { desc = "Next buffer" })
keymap.set("n", "<M-x>", "<Cmd>BufferClose<CR>", { desc = "Close buffer" })
keymap.set("n", "<M-xa>", "<Cmd>BufferCloseAllButCurrent<CR>", { desc = "Close all but current buffer" })

for i = 1, 9 do
  keymap.set("n", "<M-" .. i .. ">", "<Cmd>BufferGoto " .. i .. "<CR>", { desc = "Go to buffer " .. i })
end

keymap.set("n", "<M-0>", "<Cmd>BufferLast<CR>", { desc = "Go to last buffer" })
...
keymap.set("n", "<M-j>", "<Plug>(VM-Add-Cursor-Down)", { desc = "VM: Add cursor below" })
keymap.set("n", "<M-k>", "<Plug>(VM-Add-Cursor-Up)", { desc = "VM: Add cursor above" })
keymap.set("x", "<M-j>", "<Plug>(VM-Add-Cursor-Down)", { desc = "VM: Add cursor below" })
keymap.set("x", "<M-k>", "<Plug>(VM-Add-Cursor-Up)", { desc = "VM: Add cursor above" })
